...
AgentConfig::AgentConfig()
{
	...
	*packer = Packer( (BYTE*)ProfileBytes, size);
	...
	this->sleep1_delay = packer->Unpack32();   
	this->sleep2_delay = packer->Unpack32();   
	this->sleep3_delay = packer->Unpack32();   
	this->max_sleep_delay = packer->Unpack32(); 
	...
	this->profile.ws_path = packer->UnpackBytesCopy(&length);
	this->profile.user_agent = packer->UnpackBytesCopy(&length);
